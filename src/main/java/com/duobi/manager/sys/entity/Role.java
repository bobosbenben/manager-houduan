package com.duobi.manager.sys.entity;
...
public class Role extends DataEntity<Role, Long> {
    ...
    private List<Organization> organizationList = new ArrayList<>(); // 按明细设置数据范围

    // 数据范围（1：所有数据；2：按明细设置；3：所在机构及以下数据；4：所在机构数据；5：仅本人数据）
    public static final Integer DATA_SCOPE_ALL = 1;
    public static final Integer DATA_SCOPE_ORGANIZATION_AND_CHILD = 2;
    public static final Integer DATA_SCOPE_ORGANIZATION = 3;
    public static final Integer DATA_SCOPE_SELF = 4;
    public static final Integer DATA_SCOPE_CUSTOM = 5;

    public static final String[] DATA_SCOPE_STR = {"未定义", "所有数据", "所在机构及以下数据", "所在机构数据", "仅本人数据", "按明细设置"};
    ...
    public void setOrganizationIds(String organizationIds) {
        ...
        if (organizationIds != null){
            ...
            setOrganizationIdList(tempList);
        }
    }
